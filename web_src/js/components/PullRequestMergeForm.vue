...
.merge-message-textarea {
  ...
  background-image: linear-gradient(to right, transparent 0, transparent calc(72ch), rgba(255, 68, 68, 0.3) calc(72ch), rgba(255, 68, 68, 0.3) calc(72ch + 2px), transparent calc(72ch + 2px)) !important;
